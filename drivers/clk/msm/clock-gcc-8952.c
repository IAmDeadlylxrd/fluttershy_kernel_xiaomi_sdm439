...
static struct pll_freq_tbl apcs_c1_pll_freq[] = {
	...
	F_APCS_PLL(2268000000UL, 127, 0x0, 0x1, 0x0, 0x0, 0x0),
        F_APCS_PLL(2438400000UL, 140, 0x0, 0x1, 0x0, 0x0, 0x0),
	F_APCS_PLL(2768000000UL, 180, 0x0, 0x1, 0x0, 0x0, 0x0),
};
...
static struct pll_clk a53ss_c1_pll = {
	...
	.c = {
		...
		.fmax = (unsigned long [VDD_HF_PLL_NUM]) {
			...
			[VDD_HF_PLL_NOM] = 2268000000UL,
                        [VDD_HF_PLL_NOM] = 2460000000UL,
			[VDD_HF_PLL_NOM] = 2768000000UL,
		},
...
static struct alpha_pll_clk gpll3_clk_src = {
	...
	.c = {
		...
		VDD_DIG_FMAX_MAP1(NOMINAL, 1500000000),
...
static int msm_gcc_probe(struct platform_device *pdev)
{
	...
	if (compat_bin || compat_bin3 || compat_bin5 || compat_bin6) {
		...
		if (compat_bin5 || compat_bin6) {
			...
			gpll3_clk_src.c.fmax[VDD_DIG_NOMINAL] = 1500000000;
